...
export default function Login() {
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="w-full card shrink-0   max-w-sm shadow-2xl bg-base-100   p-8 space-y-3 rounded-xl container mx-auto">
                ...
                <div className="flex justify-center space-x-4">
                    <button aria-label="Log in with Google" onClick={handleGoogleSignIn} className="p-3 btn btn-ghost rounded-sm">
